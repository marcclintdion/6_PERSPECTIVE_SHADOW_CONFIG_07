        ...
        #ifdef __APPLE__                                                                                                                                   
        //---------------                                                                                                                                  
        filePathName = [[NSBundle mainBundle] pathForResource:@"room_10_DOT3.png"];                                           
        if(filePathName != nil)                                                                                                                                
        {                                                                                                                                                  
        ...
        //---------------------                                                                                                                            
        filePathName = [[NSBundle mainBundle] pathForResource:@"room_10" ofType:@"png"];                                                
        if(filePathName != nil)                                                                                                                                
        {                                                                                                                                                  
                image = imgLoadImage([filePathName cStringUsingEncoding:NSASCIIStringEncoding]);                                                           
